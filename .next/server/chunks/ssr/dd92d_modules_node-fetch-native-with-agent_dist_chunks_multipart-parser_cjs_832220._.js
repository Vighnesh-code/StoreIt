...
__turbopack_require__("[externals]/ [external] (node:fs, cjs)"), __turbopack_require__("[externals]/ [external] (node:path, cjs)");
const node = __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/node.cjs [app-rsc] (ecmascript)");
__turbopack_require__("[externals]/ [external] (node:http, cjs)"), __turbopack_require__("[externals]/ [external] (node:https, cjs)"), __turbopack_require__("[externals]/ [external] (node:zlib, cjs)"), __turbopack_require__("[externals]/ [external] (node:stream, cjs)"), __turbopack_require__("[externals]/ [external] (node:buffer, cjs)"), __turbopack_require__("[externals]/ [external] (node:util, cjs)"), __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/shared/node-fetch-native-with-agent.61758d11.cjs [app-rsc] (ecmascript)"), __turbopack_require__("[externals]/ [external] (node:url, cjs)"), __turbopack_require__("[externals]/ [external] (node:net, cjs)");
let s = 0;
const S = {
    START_BOUNDARY: s++,
...
//# sourceMappingURL=dd92d_modules_node-fetch-native-with-agent_dist_chunks_multipart-parser_cjs_832220._.js.map